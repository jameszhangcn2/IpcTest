...
PAGE_HOME_SUBMENU_TABLE = [
    {"sub_menu_name": "home_01",      "id_pictures":[{"path":TEMPLATE_HOMEPAGE01_KMH_IMG, "roi":(500, 400, 700, 300), "score":0.8},]},
    {"sub_menu_name": "home_02",      "id_pictures":[{"path":TEMPLATE_HOMEPAGE02_ECO_IMG, "roi":(0, 0, 1280, 720), "score":0.8},
                                                     {"path":TEMPLATE_HOMEPAGE02_POWER_IMG, "roi":(0, 0, 1280, 720), "score":0.8},
                                                     {"path":TEMPLATE_HOMEPAGE02_CHARGE_IMG, "roi":(0, 0, 1280, 720), "score":0.8},]},
]

PAGE_SETTING_SUBMENU_TABLE = [
    {"sub_menu_name": "setting_01",   "id_pictures":[{"path":TEMPLATE_SETTING_DISPLAY_IMG, "roi":(0, 0, 1280, 720), "score":0.8},
                                                     {"path":TEMPLATE_SETTING_DISPLAY_IMG, "roi":(0, 0, 1280, 720), "score":0.8},]},
]

PAGE_MESSAGE_SUBMENU_TABLE = [
    {"sub_menu_name": "tripa",   "id_pictures":[{"path":TEMPLATE_MESSAGE_SUBMENU_IMG, "roi":(0, 0, 1280, 720), "score":0.8},]},
]

PAGE_MUSIC_SUBMENU_TABLE = [
    {"sub_menu_name": "tripa",   "id_pictures":[{"path":TEMPLATE_MUSIC_SUBMENU_IMG, "roi":(0, 0, 1280, 720), "score":0.8},]},
]

PAGE_VEHICLE_SUBMENU_TABLE = [
    {"sub_menu_name": "tyre",   "id_pictures":[{"path":TEMPLATE_VEHICLE_TYRE_IMG, "roi":(0, 0, 1280, 720), "score":0.8},]},
    {"sub_menu_name": "serviceday",   "id_pictures":[{"path":TEMPLATE_VEHICLE_SERVICEDAY_IMG, "roi":(0, 0, 1280, 720), "score":0.8},]},
]

PAGE_ACC_SUBMENU_TABLE = [
    {"sub_menu_name": "acc01",   "id_pictures":[{"path":TEMPLATE_ACC_SUBMENU_IMG, "roi":(0, 0, 1280, 720), "score":0.8},]},
]


PAGE_TRIP_SUBMENU_TABLE = [
    {"sub_menu_name": "tripa",   "id_pictures":[{"path":TEMPLATE_TRIPA_IMG, "roi":(0, 0, 1280, 720), "score":0.8},]},
    {"sub_menu_name": "tripb",   "id_pictures":[{"path":TEMPLATE_TRIPB_IMG, "roi":(0, 0, 1280, 720), "score":0.8},]},
]
